...
<html>
	...
	<head>
		...
		<script>
			...
			xhr.open("POST", "includes/recent.php");
...
?>
 ...
 <div class="productThumbnail" id="slide1">
            ...
            <div class="productThumbnail" id="slide2">
            ...
            <div class="productThumbnail" id="slide3">
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price"><h1>Rs. <?php echo htmlentities($row['productPrice']);?></h1></span>
									...
									<div class="col-sm-2">
										<div class="cart-quantity">
											<div class="quant-input">
								                <div class="arrows">
								                  <div class="plus"><span class="ir"><i class="icon fa fa-sort-asc"></i></span></div>
											
								                  <div class="minus"><span class="ir"><i class="icon fa fa-sort-desc"></i></span></div>
								                </div>
								                <font color="#333"><input type="text" value="1"></font>
							              </div>
							            </div>
							...
							<div class="product-social-link m-t-20 text-right">
								<span class="social-label"><font color="#333">Share :</font></span>
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text"><font color=#333><?php echo $row['productDescription'];?></font></p>
									</div>	
								</div><!-- /.tab-pane -->
													...
													<table class="table table-bordered">	
														<thead>
															<tr>
																...
																<th><font color='#333'>1 star</font></th>
																<th><font color='#333'>2 star</font></th>
																<th><font color='#333'>3 star</font></th>
																<th><font color='#333'>4 star</font></th>
																<th><font color='#333'>5 star</font></th>	

															</tr>
														</thead>	
														<tbody>
															<tr>
																<td class="cell-label"><font color='#333'>Quality</font></td>
															...
															<tr>
																<td class="cell-label"><font color='#333'>Price</font></td>
															...
															<tr>
																<td class="cell-label"><font color='#333'>Value</font></td>
														...
														<div class="row">
															<div class="col-sm-6">
																<div class="form-group">
																	<label for="exampleInputName"><font color='#333'>Your Name</font> <span class="astk">*</span></label>
																<input type="text" class="form-control txt" id="exampleInputName" placeholder="" name="name" required="required">
																</div><!-- /.form-group -->
																<div class="form-group">
																	<label for="exampleInputSummary"><font color='#333'>Summary</font> <span class="astk">*</span></label>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview"><font color='#333'>Review</font> <span class="astk">*</span></label>
...
<?php $cid=$row['category'];
			$subcid=$row['subCategory']; } ?></div></div></div>
<!-- ====================================================================== UPSELL PRODUCTS ============================================== -->
			...
			<div class="product-price">	
				<span class="productPrice">
					Rs.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <div class="originalPrice"><span class="originalPrice">Rs.
										     <?php echo htmlentities($rw['productPriceBeforeDiscount']);?></span></div>
