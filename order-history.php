		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-sub-total item"><font color = #333>Shipping Charge</font></th>
					<th class="cart-total item"><font color = #333>Grandtotal</font></th>
...
?>
				<tr>
					<td><font color= #333><?php echo $cnt;?></font></td>
					<td class="cart-image">
					...
					<td class="cart-product-quantity"><font color = #333>
						<?php echo $qty=$row['qty']; ?>   </font>
		            		</td>
					<td class="cart-product-sub-total"><font color = #333><?php echo $price=$row['pprice']; ?> </font> </td>
					<td class="cart-product-sub-total"><font color = #333><?php echo $shippcharge=$row['shippingcharge']; ?> </font> </td>
					<td class="cart-product-grand-total"><font color = #333><?php echo (($qty*$price)+$shippcharge);?></font></td>
					<td class="cart-product-sub-total"><font color = #333><?php echo $row['paym']; ?>  </font></td>
					<td class="cart-product-sub-total"><font color = #333><?php echo $row['odate']; ?> </font> </td>
