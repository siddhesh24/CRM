...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item"><font color = #333>Remove</font></th>
					...
					<th class="cart-total last-item"><font color = #333>Grandtotal</font></th>
				</tr>
			</thead><!-- /thead -->
			<tfoot>
				<tr>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		...
		<tbody>
				<tr>
					<td>
						<div class="form-group"><font color = "#333">
